...
public class TTTConsoleNonOO2P {
   ...
   public static int[][] board = null; // game board in 2D array
   ...
   public static void inputRowsCols() {
	  boolean result = false;
	  do {
		  System.out.print("please insert the row : ");
	 	  ROWS = in.nextInt();
	 	  System.out.print("please insert the column : ");
	 	  COLS = in.nextInt();
	 	  if(COLS < 3 || ROWS < 3) {
	 		 System.out.println("please insert valid column and rows. Try again ...");
	 	  }else if(COLS == ROWS) {
	 		  result = true;
